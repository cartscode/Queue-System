            ...
            <div id="registerForm">
                ...
                <form method="POST" action="">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="recovery_question" class="form-control" placeholder="Enter a recovery question" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Recovery Answer</label>
                        <input type="text" name="recovery_answer" class="form-control" placeholder="Enter the answer" required>
                    </div>
